            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div class="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none">
                ...
                <div class="mt-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-6">
                    <div class="group relative px-5 py-3 w-full bg-white rounded-lg overflow-hidden ">
                        <div class="mt-3">
                        ...
                        <div class="flex justify-center item-center">
                            <a href="#" id="showUnixTime" class="text-sm font-semibold text-indigo-500">See Previous result</a>
                            <a href="#" id="hideUnixTime" class="text-sm font-semibold text-indigo-500 hidden">Hide Previous result</a>
                        </div>
                    ...
                    <div class="group relative px-5 py-3 w-full h-auto bg-white rounded-lg overflow-hidden ">
                        <div class="mt-3">
                        ...
                        <div class="flex justify-center item-center">
                            <a href="#" id="showEmails" class="text-sm font-semibold text-indigo-500">See Previous result</a>
                        </div>
                    ...
                    <div class="group relative px-5 py-3 w-full h-auto bg-white rounded-lg overflow-hidden ">
                        ...
                        <form class="mt-5 space-y-6" id="FlipForm">
                          ...
                          <div class="flex items-center mt-2 justify-evenly">
                            <h2 class="head text-lg font-semibold text-gray-500">Head: </h2>
                            <h2 class="tail text-lg font-semibold text-gray-500">Tail: </h2>
                          </div>

                        <div class="flex justify-center item-center">
                            <a href="#" id="showFlips" class="text-sm font-semibold text-indigo-500">See Previous result</a>
                        </div>
